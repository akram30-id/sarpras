<div class="row justify-content-center">
	<div class="col-sm-6">
		...
		<div class="card boder-0 shadow p-3" style="border-radius: 16px;">
			<div class="card-body">
				<h3 class="text-center mt-4 mb-5">Tambah Foto Area</h3>
				<form method="POST" class="needs-validation" action="<?= base_url('area/upload_photos/' . $areaCode) ?>" enctype="multipart/form-data" novalidate>
					<div class="mb-3">
