	...
	<div class="col-sm-6">
		...
		<div class="card boder-0 shadow p-3" style="border-radius: 16px;">
			<div class="card-body">
				...
				<form class="needs-validation" novalidate method="POST" action="<?= base_url('user/do_register') ?>" enctype="multipart/form-data">
					<div class="mb-3">
					...
					<div class="mb-3">
						...
						<select class="form-select" name="role" required>
							...
							<?php foreach ($roles as $s) : ?>
								<option value="<?= $s->role ?>"><?= $s->role_name ?></option>
							<?php endforeach; ?>
						</select>
						<div class="invalid-feedback">
					...
					<div class="mb-3">
						...
						<input type="text" class="form-control" id="born_at" name="born_at" required>
						<div class="invalid-feedback">
