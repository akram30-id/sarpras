	...
	<div class="col-sm-8">
		...
		<div class="card boder-0 shadow p-3" style="border-radius: 16px;">
			<div class="card-body">
				...
				<form class="needs-validation" novalidate method="POST" action="<?= base_url('item/do_input') ?>" enctype="multipart/form-data">
					<div class="mb-1">
					...
					<div class="row mb-3">
						...
						<div class="col-sm-4">
							...
							<input type="text" class="form-control" id="unit_qty" name="unit_qty" value="gram" required>
							<div class="invalid-feedback">
								Satuan wajib diisi.
							</div>
						</div>
					...
					<div class="mb-3">
						...
						<textarea type="text" class="form-control" id="description" rows="5" name="description" required></textarea>
						<div class="invalid-feedback">
